  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        // For signup, we'll create the user but not assign a role yet
        // We'll modify the API to support this
        const newUser = await authAPI.signupEmailWithoutRole(email, password);
        ...
        // After signup, always go to role selection
        navigate('/role-selection');
      }
    } catch (error) {
      toast({
