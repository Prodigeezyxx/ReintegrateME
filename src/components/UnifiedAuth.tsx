    ...
    try {
      if (mode === 'login') {
        ...
        if (user?.role) {
          ...
          // User doesn't have a role yet, go to role selection
        ...
        toast({
          ...
          description: "Please check your email to verify your account, then select your role to continue",
        });
  ...
  return (
    <div className="mobile-container p-6 bg-white min-h-screen">
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="h-20 w-20 rounded-2xl overflow-hidden mb-8">
          <img 
        ...
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold text-center mb-2">
            {mode === 'login' ? 'Welcome Back' : 'Join ReME'}
          </h1>
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              <button className="flex justify-center items-center py-2.5 border border-gray-300 rounded-md hover:bg-gray-50" disabled>
